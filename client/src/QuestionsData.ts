...
const questions: QuestionData[] = [
    {
        ...
        answers: [
            {
                answerId: 1,
                content: 'Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Duis dictum turpis eu turpis luctus, ac faucibus dolor sodales. Quisque efficitur magna quis elit ultricies, vel egestas ipsum maximus. Aliquam viverra malesuada pretium. Pellentesque ut sem dolor.',
                userName: 'Jack',
                created: new Date(),
            },
            {
